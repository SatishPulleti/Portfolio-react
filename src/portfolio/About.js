    ...
    return(
        <div class="outerdiv">
            ...
            <div class="main-details">
                <div>
                    <label>Name:</label><span class="details">Pulleti L S N V Satish</span><br/><br/>
                    <label>Date of Birth:</label><span class="details">06 December 2003</span><br/><br/>
                    ...
                    <label>Phone No:</label><span class="details">+91 9505644949</span><br/><br/>
                    <label>Email:</label><span class="details">pulletisatish123@gmail.com</span><br/><br/>
                ...
                <div class="education">
                    ...
                    <h6>CGPA: <span class="result">9.26</span></h6>
                    <br/>
                    <h5 class="clgname">Aditya Junior College</h5>
                    <h6>(2019-2021)</h6>
                    <h6>Intermediate - M.P.C</h6>
                    <h6>Percentage: <span class="result">97.6%</span></h6>

                </div>
            </div>
            <div class="work">
                <h2>Work experience</h2>
                <h5 class="clubname">Microsoft Student Chapter - VIT AP (2022-23)</h5>
                <p>Worked as a core member in the design team for
                Microsoft Student Chapter club during the
                academic year 2022-2023.</p>
                <br/>
                <h5 class="clubname">NextGen Cloud Club - VIT AP (2023-Present)</h5>
                <p>Currently Working as a core member in the Technical team.</p>
            </div>
        </div>
    )
}
